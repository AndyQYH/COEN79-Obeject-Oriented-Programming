...
namespace coen79_lab8
{
    ...
    void deque<Item>::operator=(const deque<Item>& source) {
        ...
        for (size_type bp_array_index = 0; bp_array_index < source.bp_array_size; ++bp_array_index)
        {
            ...
            else
            {
                ...
                // STUDENT WORK...
                if(source.block_pointers[bp_array_index] == source.back_ptr)
                {
                  //block_pointers[bp_array_index] = source.block_pointers[bp_array_index];
                  back_ptr = block_pointers[bp_array_index];
                }
    ...
    deque<Item>::~deque () {
        ...
        // STUDENT WORK...
        for (size_type bp_array_index = 0; bp_array_index < bp_array_size; ++bp_array_index)
        {
          delete[] block_pointers[bp_array_index];
          block_pointers[bp_array_index] = NULL;
        }
