...
int main(int argc, char const *argv[]) {
    ...
    // Testing list_occurrences functionality.
    ...
    // Testing list_remove_at functionality.
    ...
    // Testing list_remove_dups functionality.
    {
    ...
    // Testing list_detect_loop functionality.
    {
